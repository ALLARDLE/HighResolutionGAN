...
# https://github.com/eriklindernoren/PyTorch-GAN/blob/master/implementations/esrgan/esrgan.py
"""
...
if opt.epoch != 0:
    ...
    try:
        ...
        logger.exception("Error loading saved models")
...
try:
    ...
    logger.exception("Error in dataloader initialization")
# ----------
#  Training
# ----------
...
try:
    ...
    logger.exception("Error in training loop")
